...
class CellViewModelType3 : CellViewModel<ViewHolderType1>() {

    override fun bindViewHolder(adapter: GenericAdapter<CellViewModel<RecyclerView.ViewHolder>>?,
                                holder: ViewHolderType1?) {
    }
