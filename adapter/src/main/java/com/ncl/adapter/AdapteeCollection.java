 ...
 * widget.
 *
 * This library provides a default implementation of com.intervalintl.renderer.AdapteeCollection named ListAdapteeCollection,
 * use it if needed or create your own com.intervalintl.renderer.AdapteeCollection implementations.
 *
...
public interface AdapteeCollection<T> {
  ...
  /**
   * Add a new element to the com.intervalintl.renderer.AdapteeCollection.
   *
  ...
  /**
   * Remove one element from the com.intervalintl.renderer.AdapteeCollection.
   *
   * @param  element to add.
  ...
  /**
   * Add a element collection to the com.intervalintl.renderer.AdapteeCollection.
   *
  ...
  /**
   * Remove a element collection to the com.intervalintl.renderer.AdapteeCollection.
   *
   * @param elements to add.
  ...
  /**
   * Remove all element inside the com.intervalintl.renderer.AdapteeCollection.
   */
  void clear();
}
